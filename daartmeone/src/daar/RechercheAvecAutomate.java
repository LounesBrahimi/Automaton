...
public class RechercheAvecAutomate {
	...
	public static void main(String[] args) {
	    ...
	    if (regEx.length()<1) {
	      System.err.println("  >> ERROR: empty regEx.");
		    ...
		    DFA dfa = new DFA(nSansEpsilons.nouveauNdfaMatrix, n.getnLignes(), n.getnColonnes());
		    dfa.determinate();
		    printMatrix(dfa.dfaMatrix);
		    System.out.println("=======>> Recherche <<=======");
		    String text = "Bonjour le monde\n"
		    		+     " hello world!\n"
		    		+     "    it's sunday hello my friend\n"
		    		+     "it run in the hell today";
		    SearchWithAutomaton s = new SearchWithAutomaton(dfa.dfaMatrix, n.getnLignes(), n.getnColonnes()); 
		    System.out.println("Resultat de la recherche : "+s.search(text));
